...
public sealed class ParameterManager
{
    ...
    private readonly VehicleProfileService _vehicle;
    ...
    public ParameterManager(
        ...
        FirmwareProfileService firmware,
        VehicleProfileService vehicle,
        ...
        CancellationToken ct = default)
    {
        ...
        // ── Annotate all entries with firmware-specific metadata ───────────
        _log.LogInformation("Annotating {Count} parameters with {Firmware} metadata",
            _params.Count, _firmware.ActiveFirmwareDisplayName);
        await _firmware.ActiveAdapter.AnnotateParametersAsync(
            _params.Values, _vehicle.ActiveProfile, ct);
