...
public class DroneState
{
    ...
    public ushort[] RawChannels { get; set; } = new ushort[18];
    public byte RcChannelCount { get; set; } = 0;    // actual chancount from FC (0 = none)
    ...
    public DroneState(DroneState other)
    {
        ...
        RcChannelCount = other.RcChannelCount;
